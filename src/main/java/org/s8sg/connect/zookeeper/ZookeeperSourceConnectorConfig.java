...
public class ZookeeperSourceConnectorConfig extends AbstractConfig {
  ...
  public ZookeeperSourceConnectorConfig(ConfigDef config, Map<String, String> parsedConfig) {
    super(config, parsedConfig);
  }

  public ZookeeperSourceConnectorConfig(Map<String, String> parsedConfig) {

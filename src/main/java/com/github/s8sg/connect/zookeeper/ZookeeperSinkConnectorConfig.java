...
public class ZookeeperSinkConnectorConfig extends AbstractConfig {
  ...
  public ZookeeperSinkConnectorConfig(ConfigDef config, Map<String, String> parsedConfig) {
    super(config, parsedConfig);
  }

  public ZookeeperSinkConnectorConfig(Map<String, String> parsedConfig) {
